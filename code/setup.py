...
VERSION = imp.load_source('version', r'C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\darkflow\version.py')
...
if os.name =='nt' :
    ...
    ext_modules=[
        Extension("darkflow.cython_utils.nms",
            sources=[r"C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\cython_utils\nms.pyx"],
            libraries=["m"], # Unix-like specific
            include_dirs=[numpy.get_include()]
        ),        
        Extension("darkflow.cython_utils.cy_yolo2_findboxes",
