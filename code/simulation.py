...
detectionTime = 5
speeds = {'car':2.25, 'bus':1.8, 'truck':1.8, 'rickshaw':2, 'bike':2.5, 'cycleboi':1}  # average speeds of vehicles
...
vehicleTypes = {0:'car', 1:'bus', 2:'truck', 3:'rickshaw', 4:'bike', 5:'cycleboi'}
directionNumbers = {0:'right', 1:'down', 2:'left', 3:'up'}

# Coordinates of signal image, timer, and vehicle count
signalCoods = [(530,230),(810,230),(810,570),(530,570), (530,570)]
signalTimerCoods = [(530,210),(810,210),(810,550),(530,550), (530,570)]
vehicleCountCoods = [(480,210),(880,210),(880,550),(480,550), (530,570)]
vehicleCountTexts = ["0", "0", "0", "0","0"]
...
def setTime():
    global noOfCars, noOfBikes, noOfBuses, noOfTrucks, noOfRickshaws, noOfLanes, noofcyclebois
    global carTime, busTime, truckTime, rickshawTime, bikeTime, noofcyclebois
...
def generateVehicles():
    while(True):
        ...
        if(vehicle_type==4) or (vehicle_type==5):
            lane_number = 0
        else:
...
class Main:
    ...
    background = pygame.image.load(r'C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\images\mod_int.png')
    ...
    redSignal = pygame.image.load(r'C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\images\signals\red.png')
    yellowSignal = pygame.image.load(r'C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\images\signals\yellow.png')
    greenSignal = pygame.image.load(r'C:\Users\karan\Python\Projects\Traffic light Final Year Project\Code\YOLO\darkflow\images\signals\green.png')
